...
class DietitionDetailController extends GetxController {
  ...
  late DietitionModel dietition;

  @override
  void onInit() {
    super.onInit();
    dietition = Get.arguments;
  }


  void toggleAbout() => isAboutExpanded.value = !isAboutExpanded.value;
  void toggleExperience() => isExperienceExpanded.value = !isExperienceExpanded.value;
  void toggleEducation() => isEducationExpanded.value = !isEducationExpanded.value;
