import 'package:diet_app_mobile/controller/dietitian/dietitian_vote_view_controller.dart';
...
class DietitianVoteView extends StatelessWidget {
  const DietitianVoteView({super.key});

  @override
  Widget build(BuildContext context) {
    final DietitianVoteController controller =
        Get.put(DietitianVoteController());
        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(
              style: ButtonStyle(
                  backgroundColor:
                      WidgetStatePropertyAll(AppColor.vividBlue.getColor())),
              onPressed: () {
                Get.back();
                Get.back();
              },
  ...
  SizedBox _buildStarRow(DietitianVoteController controller) {
    return SizedBox(
